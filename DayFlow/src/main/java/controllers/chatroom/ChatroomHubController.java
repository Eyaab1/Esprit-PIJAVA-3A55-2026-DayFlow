...
public class ChatroomHubController {
            ...
            Platform.runLater(() -> {
                try {
                    controllers.navigation.NavigationManager.show(
                            "/user/account/login.fxml", "DayFlow — Connexion");
                } catch (Exception e) {
    ...
    private void doSearch(String keyword) {
        ...
        // Contrôle de saisie
        try {
            services.chatroom.MessageValidator.validateSearch(keyword);
    ...
    private void onSendMessage() {
        ...
        String validated;
        try {
            validated = services.chatroom.MessageValidator.validateContent(text);
        } catch (IllegalArgumentException e) {
    ...
    private void onEditMessage(Message m) {
        ...
        btnOk.setOnAction(e -> {
            ...
            try {
                String validated = services.chatroom.MessageValidator.validateContent(trimmed);
